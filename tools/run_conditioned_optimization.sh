...
# Run controlled ablations on the existing frozen release. Selection uses validation only.
...
run_one conditioned_opt_balanced_v1 --sampling balanced
run_one conditioned_opt_diverse_v1 --reference-sampling diverse
run_one conditioned_opt_contact_v1 --contact-weight 0.01
